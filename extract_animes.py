...
# Mapeamentos manuais para animes
manual_subs = {
    "A Voz do Silêncio (Koe no Katachi)": "Koe no Katachi",
    "Your Name (Kimi no Na wa)": "Kimi no Na wa",
    "Saint Seiya: Lenda do Santuário": "Lenda do Santuario",
    "Ghost in the Shell (O Fantasma do Futuro)": "Ghost in the Shell",
    "Wolf Children (Crianças Lobo)": "Criancas Lobo",
    "Weathering with You (O Tempo com Você)": "O Tempo com Voce",
    "A Whisker Away (Olhos de Gato)": "Olhos de Gato",
}
...
while i < len(lines):
    ...
    if line.startswith("#EXTINF"):
        ...
        for title in titles:
            ...
            # Remove "Saga " do início para busca
            if title.startswith("Saga "): targets.append(normalize(title[5:]))
            ...
            for target in targets:
                if not target or len(target) < 3: continue
